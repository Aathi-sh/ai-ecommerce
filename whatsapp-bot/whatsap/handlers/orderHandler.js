...
// // handlers/orderHandler.js - COMPLETE PROFESSIONAL VERSION WITH WEBSOCKET
// import pkg from 'whatsapp-web.js';
// import apiService from "../../services/apiService.js";
// import handlePaymentVerification from './paymentVerificationHandler.js';
// import notificationWebSocketServer from '../../services/notification-websocket-server.js';
...
//             // 🔥 WEB SOCKET NOTIFICATION ONLY 🔥
//             try {
//                 console.log(`🎯 Sending WebSocket notification for order: ${newOrder.orderNumber}`);
                
//                 // Send real-time notification via WebSocket
//                 const adminCount = notificationWebSocketServer.broadcastNewOrder(newOrder);
//                 console.log(`📡 WebSocket notification sent to ${adminCount} admin(s)`);
                
//             } catch (notifyError) {
//                 console.error(`❌ WebSocket notification error:`, notifyError.message);
