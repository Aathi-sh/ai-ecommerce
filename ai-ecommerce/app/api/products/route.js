...
//       _id: productObj.category._id || productObj.category,
//       name: productObj.category.name || null,
//       slug: productObj.category.slug || null
//     } : null,
//     subCategory: productObj.subCategory ? {
//       _id: productObj.subCategory._id || productObj.subCategory,
//       name: productObj.subCategory.name || null,
//       slug: productObj.subCategory.slug || null
//     } : null
//   };
// };
...
//       path: 'category',
//       select: 'name slug',
//       options: { strict: false } // This helps with invalid IDs
//     })
//     .populate({
//       path: 'subCategory',
//       select: 'name slug',
...
//     console.log(`📊 Found ${products.length} products (total: ${await Product.countDocuments(query)})`);
...
//           // Set to null to avoid further errors
//           product.category = null;
//           product.subCategory = null;
//         }
//         return product;
