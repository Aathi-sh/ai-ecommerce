...
//     const message = encodeURIComponent(`I'm interested in: ${productDetails}\nPrice: ₹${product.discountPrice?.toLocaleString()}`);
...
//             <ChevronRight style={{ width: isMobile ? "10px" : "12px", height: isMobile ? "10px" : "12px", flexShrink: 0 }} />
//             {product.category && (
//               <>
...
//                       >
//                         <Minus style={{ width: isMobile ? "12px" : "16px", height: isMobile ? "12px" : "16px" }} />
//                       </button>
//                       <span style={{ width: isMobile ? "40px" : "48px", textAlign: "center", fontSize: isMobile ? fontSizes.base : fontSizes.lg, fontWeight: fontWeights.medium }}>{quantity}</span>
//                       <button
...
//                         className="flex items-center justify-center hover:bg-gray-50 disabled:opacity-50 disabled:cursor-not-allowed"
//                       >
//                         <Plus style={{ width: isMobile ? "12px" : "16px", height: isMobile ? "12px" : "16px" }} />
//                       </button>
...
//           <div style={{ backgroundColor: surfaceColor, borderRadius: radiusLg, boxShadow: shadowSm, border: `1px solid ${borderColor}`, overflow: "hidden" }}>
//             <div style={{ borderBottom: `1px solid ${borderColor}`, overflowX: "auto" }}>
...
//                         transition: transitionFast
//                       }}
//                       className="whitespace-nowrap flex items-center gap-1.5 sm:gap-2 hover:text-gray-900"
//                     >
...
//                   <div style={{ fontSize: isMobile ? fontSizes.sm : fontSizes.base, color: textSecondary, lineHeight: "1.6" }} className="whitespace-pre-wrap">
//                     {product.description || 'No description available for this product.'}
//                   </div>
                  
//                   {product.shortDescription && (
//                     <div style={{ backgroundColor, borderRadius: radiusMd }} className="mt-3 sm:mt-4 p-3 sm:p-4">
//                       <h4 style={{ fontSize: isMobile ? fontSizes.sm : fontSizes.base, fontWeight: fontWeights.semibold, color: textPrimary }} className="mb-1.5 sm:mb-2">Key Highlights</h4>
//                       <p style={{ fontSize: isMobile ? fontSizes.xs : fontSizes.sm, color: textSecondary }}>{product.shortDescription}</p>
//                     </div>
//                   )}
                  
//                   <div className="mt-4 sm:mt-6 grid grid-cols-2 gap-2 sm:gap-3">
//                     {product.inStock && (
//                       <div className="flex items-center gap-1.5 sm:gap-2" style={{ fontSize: isMobile ? fontSizes.xs : fontSizes.sm, color: successColor }}>
//                         <CheckCircle2 style={{ width: isMobile ? "12px" : "16px", height: isMobile ? "12px" : "16px" }} /> In Stock
//                       </div>
//                     )}
//                     {product.isFeatured && (
//                       <div className="flex items-center gap-1.5 sm:gap-2" style={{ fontSize: isMobile ? fontSizes.xs : fontSizes.sm, color: warningColor }}>
//                         <Award style={{ width: isMobile ? "12px" : "16px", height: isMobile ? "12px" : "16px" }} /> Featured
//                       </div>
//                     )}
//                     {product.isOnSale && (
//                       <div className="flex items-center gap-1.5 sm:gap-2" style={{ fontSize: isMobile ? fontSizes.xs : fontSizes.sm, color: errorColor }}>
//                         <Zap style={{ width: isMobile ? "12px" : "16px", height: isMobile ? "12px" : "16px" }} /> On Sale
//                       </div>
//                     )}
//                     {product.isNewArrival && (
//                       <div className="flex items-center gap-1.5 sm:gap-2" style={{ fontSize: isMobile ? fontSizes.xs : fontSizes.sm, color: primaryColor }}>
//                         <Sparkles style={{ width: isMobile ? "12px" : "16px", height: isMobile ? "12px" : "16px" }} /> New Arrival
//                       </div>
//                     )}
//                     {product.isBestSeller && (
//                       <div className="flex items-center gap-1.5 sm:gap-2" style={{ fontSize: isMobile ? fontSizes.xs : fontSizes.sm, color: secondaryColor }}>
//                         <TrendingUp style={{ width: isMobile ? "12px" : "16px", height: isMobile ? "12px" : "16px" }} /> Best Seller
//                       </div>
//                     )}
//                   </div>
//                 </div>
...
//                     <div style={{ backgroundColor }} className="flex items-center gap-3 sm:gap-4 md:gap-6 p-3 sm:p-4 rounded-xl">
//                       <div className="text-center">
//                         <div style={{ fontSize: isMobile ? fontSizes.xl : fontSizes["2xl"], fontWeight: fontWeights.bold, color: textPrimary }}>{product.averageRating.toFixed(1)}</div>
//                         <RatingStars rating={product.averageRating} size="sm" />
//                         <div style={{ fontSize: fontSizes.xs, color: textSecondary }} className="mt-1">{product.totalReviews} reviews</div>
//                       </div>
//                       <div className="flex-1">
//                         <p style={{ fontSize: isMobile ? fontSizes.xs : fontSizes.sm, color: textSecondary }}>Customer reviews will appear here</p>
//                       </div>
//                     </div>
//                   )}
...
//                         <MessageSquare style={{ width: isMobile ? "32px" : "40px", height: isMobile ? "32px" : "40px", color: borderColor, margin: "0 auto 8px" }} />
//                         <p style={{ fontSize: isMobile ? fontSizes.xs : fontSizes.sm, color: textSecondary }}>No reviews yet. Be the first to review!</p>
//                       </div>
//                     )}
//                   </div>
//                 </div>
...
//                 <div className="space-y-3 sm:space-y-4">
//                   <div>
//                     <h4 style={{ fontSize: isMobile ? fontSizes.sm : fontSizes.base, fontWeight: fontWeights.semibold, color: textPrimary }} className="mb-1 sm:mb-2">Shipping Information</h4>
//                     <p style={{ fontSize: isMobile ? fontSizes.xs : fontSizes.sm, color: textSecondary }}>Free shipping on all orders. Estimated delivery within 3-5 business days. Once shipped, you will receive a tracking number via WhatsApp.</p>
//                   </div>
//                   <div>
//                     <h4 style={{ fontSize: isMobile ? fontSizes.sm : fontSizes.base, fontWeight: fontWeights.semibold, color: textPrimary }} className="mb-1 sm:mb-2">Returns Policy</h4>
//                     <p style={{ fontSize: isMobile ? fontSizes.xs : fontSizes.sm, color: textSecondary }}>Not satisfied with your purchase? We offer a 7-day return policy. Please contact us via WhatsApp for return instructions. Items must be unused and in original packaging.</p>
//                   </div>
//                   <div>
//                     <h4 style={{ fontSize: isMobile ? fontSizes.sm : fontSizes.base, fontWeight: fontWeights.semibold, color: textPrimary }} className="mb-1 sm:mb-2">Contact Us</h4>
//                     <p style={{ fontSize: isMobile ? fontSizes.xs : fontSizes.sm, color: textSecondary }}>For any queries regarding your order, please reach out to us on WhatsApp. We're here to help!</p>
//                   </div>
//                 </div>
//               )}
//             </div>
...
//           <div style={{ marginTop: spacing.lg }}>
//             <h2 style={{ fontSize: isMobile ? fontSizes.lg : fontSizes.xl, fontWeight: fontWeights.bold, color: textPrimary }} className="mb-3 sm:mb-4">You May Also Like</h2>
//             <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 sm:gap-4">
//               {relatedProducts.map((item) => {
//                 const itemDiscount = item.mrp && item.discountPrice && item.mrp > item.discountPrice
...
//                   >
//                     <div style={{ position: "relative", paddingTop: "100%", backgroundColor }}>
//                       {item.imageUrls?.[0] && (
//                         <Image
...
//                       )}
//                       {itemDiscount > 0 && (
//                         <div style={{ position: "absolute", top: spacing.xs, left: spacing.xs, backgroundColor: errorColor, color: "#fff", fontSize: fontSizes.xs, fontWeight: fontWeights.bold, padding: "2px 6px", borderRadius: radiusFull }}>
//                           -{itemDiscount}%
//                         </div>
//                       )}
//                     </div>
//                     <div style={{ padding: isMobile ? spacing.xs : spacing.sm }}>
//                       <h3 style={{ fontSize: isMobile ? fontSizes.xs : fontSizes.sm, fontWeight: fontWeights.medium, color: textPrimary }} className="line-clamp-2 group-hover:text-blue-600 transition">
//                         {item.productName}
//                       </h3>
//                       <div className="mt-1 flex items-baseline gap-1">
//                         <span style={{ fontSize: isMobile ? fontSizes.xs : fontSizes.sm, fontWeight: fontWeights.bold, color: textPrimary }}>₹{item.discountPrice?.toLocaleString()}</span>
//                         {item.mrp > item.discountPrice && (
//                           <span style={{ fontSize: fontSizes.xs, color: textSecondary }} className="line-through">₹{item.mrp?.toLocaleString()}</span>
//                         )}
//                       </div>
//                     </div>
//                   </Link>
...
//       <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, backgroundColor: surfaceColor, borderTop: `1px solid ${borderColor}`, padding: spacing.sm, zIndex: 20 }} className="lg:hidden">
...
//             }}
//           >
//             <ShoppingCart style={{ width: "16px", height: "16px", display: "inline", marginRight: spacing.xs }} />
//             Buy Now
//           </button>
//         </div>
//       </div>

//       <div style={{ height: isMobile ? "56px" : "64px" }} className="lg:hidden"></div>
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor, fontFamily }}>
      ...
      <div style={{ maxWidth: "1280px", margin: "0 auto", padding: isMobile ? spacing.md : spacing.lg }}>
        ...
        {/* Tabs Section - Rest of the component remains the same */}
        {/* ... (keep all the tabs section, related products, and floating bar exactly as in your original code) ... */}
        
        {/* Note: The tabs section, related products, and floating action bar code remains unchanged */}
        {/* To save space, they are omitted here but you should keep them from your original file */}
