...
//     serviceType: 'both', // 'ecommerce', 'booking', or 'both'
...
//         description: 'Products, orders, inventory management, and catalog features only.',
//         icon: Store,
//         color: appTheme.colors.primary,
//         features: ['Product Management', 'Order Processing', 'Inventory Tracking', 'Customer Catalog'],
//       },
//       booking: {
//         title: 'Booking Service Only',
//         description: 'Appointments, service management, scheduling, and booking features only.',
//         icon: CalendarDays,
//         color: appTheme.colors.info,
//         features: ['Service Management', 'Appointment Scheduling', 'Booking Calendar', 'Staff Management'],
//       },
//       both: {
//         title: 'Both (E-Commerce + Booking)',
//         description: 'Full access to both e-commerce and booking features.',
//         icon: Layers,
//         color: '#7c3aed',
//         features: ['All E-Commerce Features', 'All Booking Features', 'Unified Dashboard', 'Integrated Experience'],
//       },
//     };
//     return descriptions[type] || descriptions.both;
//   };
...
//           <h2 className="text-2xl font-bold mb-2" style={{ color: appTheme.colors.textPrimary, fontFamily: appTheme.fonts.families.primary, fontSize: appTheme.fonts.sizes["2xl"], fontWeight: appTheme.fonts.weights.bold }}>Company Created!</h2>
//           <p className="mb-4" style={{ color: appTheme.colors.textSecondary, fontFamily: appTheme.fonts.families.primary }}>
//             Service Type: <strong style={{ color: appTheme.colors.primary }}>
//               {formData.serviceType === 'ecommerce' ? 'E-Commerce' : formData.serviceType === 'booking' ? 'Booking' : 'Both'}
//             </strong>
//           </p>
//           <p className="mb-4" style={{ color: appTheme.colors.textSecondary, fontFamily: appTheme.fonts.families.primary }}>
//             Company slug: <strong style={{ color: appTheme.colors.primary }}>{formData.slug}</strong>
...
//           <h1 className="text-2xl font-bold" style={{ color: appTheme.colors.textPrimary, fontFamily: appTheme.fonts.families.primary, fontSize: appTheme.fonts.sizes["2xl"], fontWeight: appTheme.fonts.weights.bold }}>Create New Company</h1>
//           <p className="mt-1 text-sm" style={{ color: appTheme.colors.textSecondary, fontFamily: appTheme.fonts.families.primary }}>
//             Set up a new company with service type selection, catalog link, and WhatsApp integration for multi-tenant messaging
//           </p>
//         </div>
...
//               {/* Service Type Selection - NEW SECTION */}
...
//                   This determines which features and pages will be available to this company.
//                 </p>
                
//                 <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
//                   {['ecommerce', 'booking', 'both'].map((type) => {
//                     const typeInfo = getServiceTypeDescription(type);
...
//                         }`}
//                         style={{
//                           borderColor: isSelected ? typeInfo.color : appTheme.colors.border,
//                           backgroundColor: isSelected ? `${typeInfo.color}10` : appTheme.colors.backgroundCard,
...
//                           </div>
//                           {isSelected && (
//                             <CheckCircle2 className="w-5 h-5" style={{ color: typeInfo.color }} />
//                           )}
//                         </div>
//                         <h4 className="font-semibold mb-1" style={{ color: appTheme.colors.textPrimary }}>
//                           {typeInfo.title}
//                         </h4>
//                         <p className="text-xs mb-3" style={{ color: appTheme.colors.textSecondary }}>
//                           {typeInfo.description}
//                         </p>
//                         <div className="space-y-1">
//                           {typeInfo.features.slice(0, 3).map((feature, idx) => (
//                             <div key={idx} className="flex items-center text-xs">
//                               <CheckCircle2 className="w-3 h-3 mr-1" style={{ color: typeInfo.color }} />
//                               <span style={{ color: appTheme.colors.textSecondary }}>{feature}</span>
//                             </div>
//                           ))}
//                         </div>
//                       </div>
...
//                 </div>
//                 {errors.serviceType && (
//                   <p className="mt-2 text-xs" style={{ color: appTheme.colors.error }}>{errors.serviceType}</p>
//                 )}
//               </div>
...
//               <div className="rounded-lg p-4 space-y-4" style={{ backgroundColor: appTheme.colors.backgroundLight }}>
//                 {/* Service Type Section - NEW */}
//                 <div className="border-b pb-4" style={{ borderColor: appTheme.colors.borderLight }}>
//                   <h3 className="font-medium mb-2" style={{ color: appTheme.colors.textPrimary, fontFamily: appTheme.fonts.families.primary }}>Service Type</h3>
//                   <div className="flex items-center gap-3">
//                     {(() => {
//                       const typeInfo = getServiceTypeDescription(formData.serviceType);
//                       const Icon = typeInfo.icon;
//                       return (
//                         <>
...
//                           </div>
//                           <div>
//                             <p className="font-medium" style={{ color: typeInfo.color }}>{typeInfo.title}</p>
//                             <p className="text-xs" style={{ color: appTheme.colors.textSecondary }}>{typeInfo.description}</p>
//                           </div>
//                         </>
//                       );
//                     })()}
...
//               <p className="text-sm" style={{ color: appTheme.colors.textSecondary }}>
//                 By clicking Create Company, you confirm that all information is correct. The company admin will receive login credentials and can configure WhatsApp settings based on the selected service type.
//               </p>
//             </div>
//           )}
